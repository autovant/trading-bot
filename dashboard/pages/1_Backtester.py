...
with st.sidebar:
    ...
    interval = st.selectbox("Interval", ["1", "5", "15", "30", "60", "240", "D"], index=2)
...
if st.session_state.backtest_results:
    ...
    m1.metric("Final Equity", f"${latest['final_equity']:,.2f}", delta=f"{latest['total_return']*100:.2f}%")
    ...
    if len(st.session_state.backtest_results) > 1:
        ...
        if combined_data:
            ...
            comp_fig = px.line(all_df, x="time", y="equity", color="Run", title="Comparative Equity Curves")
