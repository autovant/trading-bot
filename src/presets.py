from .dynamic_strategy import StrategyConfig, RegimeConfig, SetupConfig, SignalConfig, RiskConfig, IndicatorConfig, ConditionConfig
    ...
    return [
        StrategyConfig(
            ...
            regime=RegimeConfig(
                ...
                bullish_conditions=[
                    ConditionConfig(indicator_a="close", operator=">", indicator_b="ema_200")
                ],
                bearish_conditions=[
                    ConditionConfig(indicator_a="close", operator="<", indicator_b="ema_200")
                ]
            ...
            setup=SetupConfig(
                ...
                bullish_conditions=[
                    ConditionConfig(indicator_a="ema_50", operator=">", indicator_b="ema_200")
                ],
                bearish_conditions=[
                    ConditionConfig(indicator_a="ema_50", operator="<", indicator_b="ema_200")
                ]
            ...
            signals=[
                SignalConfig(
                    ...
                    entry_conditions=[
                        ConditionConfig(indicator_a="macd", operator=">", indicator_b="macd_signal"),
                        ConditionConfig(indicator_a="close", operator=">", indicator_b="ema_20")
                    ]
                )
            ],
            risk=RiskConfig(
        ...
        StrategyConfig(
            ...
            setup=SetupConfig(
                timeframe="4h",
                indicators=[
                    IndicatorConfig(name="bollinger_bands", params={"period": 20, "std_dev": 2.0})
                ],
                bullish_conditions=[
                    ConditionConfig(indicator_a="bb_width", operator=">", indicator_b=0.05)
                ],
                bearish_conditions=[
                    ConditionConfig(indicator_a="bb_width", operator=">", indicator_b=0.05)
                ]
            ...
            signals=[
                SignalConfig(
                    ...
                    entry_conditions=[
                        ConditionConfig(indicator_a="rsi_14", operator="<", indicator_b=30),
                        ConditionConfig(indicator_a="close", operator="<", indicator_b="bb_lower")
                    ]
                ),
                SignalConfig(
                    timeframe="1h",
                    ...
                    entry_conditions=[
                        ConditionConfig(indicator_a="rsi_14", operator=">", indicator_b=70),
                        ConditionConfig(indicator_a="close", operator=">", indicator_b="bb_upper")
                    ]
                )
            ],
            risk=RiskConfig(
        ...
        StrategyConfig(
            ...
            setup=SetupConfig(
                ...
                bullish_conditions=[
                    ConditionConfig(indicator_a="bb_width", operator="<", indicator_b=0.10)
                ],
                bearish_conditions=[
                    ConditionConfig(indicator_a="bb_width", operator="<", indicator_b=0.10)
                ]
            ...
            signals=[
                SignalConfig(
                    ...
                    indicators=[
                        IndicatorConfig(name="bollinger_bands", params={"period": 20, "std_dev": 2.0}),
                        IndicatorConfig(name="sma", params={"period": 20, "source": "volume"})
                    ],
                    entry_conditions=[
                        ConditionConfig(indicator_a="close", operator=">", indicator_b="bb_upper"),
                        ConditionConfig(indicator_a="volume", operator=">", indicator_b="sma_20")
                    ]
                )
            ],
            risk=RiskConfig(
        ...
        StrategyConfig(
            ...
            signals=[
                SignalConfig(
                    ...
                    indicators=[
                        IndicatorConfig(name="rsi", params={"period": 14}),
                        IndicatorConfig(name="divergence", params={"oscillator": "rsi_14", "lookback": 3})
                    ],
                    entry_conditions=[
                        ConditionConfig(indicator_a="rsi_14_div_reg_bull", operator="==", indicator_b=1.0)
                    ]
                ),
                SignalConfig(
                    timeframe="1h",
                    ...
                    entry_conditions=[
                        ConditionConfig(indicator_a="rsi_14_div_hid_bull", operator="==", indicator_b=1.0)
                    ]
                ),
                SignalConfig(
                    timeframe="1h",
                    ...
                    entry_conditions=[
                        ConditionConfig(indicator_a="rsi_14_div_reg_bear", operator="==", indicator_b=1.0)
                    ]
                ),
                SignalConfig(
                    timeframe="1h",
                    ...
                    entry_conditions=[
                        ConditionConfig(indicator_a="rsi_14_div_hid_bear", operator="==", indicator_b=1.0)
                    ]
                )
            ],
            risk=RiskConfig(
