...
class TestNewIndicators(unittest.TestCase):
    ...
    def test_obi(self):
        ob = {"bids": [[100, 10], [99, 10]], "asks": [[101, 5], [102, 5]]}
    ...
    def test_walls(self):
        ...
        ob = {
            "bids": [
                ...
                [98, 10],
                [97, 1000],
            ],  # Wall at 97. Avg (4 items) = (30+1000)/4 = 257.5. 1000 > 257.5 * 3 (772.5) -> True
            "asks": [[101, 10], [102, 10], [103, 10], [104, 10]],
        }
        walls = OrderBookIndicators.detect_liquidity_walls(
            ob, depth=4, wall_multiplier=3.0
        )
