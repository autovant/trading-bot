...
from src.strategy import TradingStrategy, MarketRegime, TradingSetup, TradingSignal
...
def strategy_configs():
    ...
    strat1.signals[0].entry_conditions = [ConditionConfig(indicator_a=1, operator="==", indicator_b=1)]
    ...
    strat2 = StrategyConfig(
        ...
        signals=[
            SignalConfig(
                ...
                direction="short",
                entry_conditions=[ConditionConfig(indicator_a=1, operator="==", indicator_b=1)]
            )
        ],
        risk=RiskConfig()
    )
